...
function IconCopyright() {
  return (
    <div className="relative shrink-0 size-[22px]" data-name="icon/copyright">
...
function Copyrights() {
  return (
    <div className="content-stretch flex gap-[12px] items-center relative shrink-0" data-name="copyrights">
      <IconCopyright />
      <div className="flex flex-col font-['Montez:Regular',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#70a4ca] text-[22px] text-nowrap">
  ...
  return (
    <div className="relative shrink-0 w-full bg-transparent" data-name="section/footer">
      <div className="flex flex-col items-center overflow-clip rounded-[inherit] size-full bg-transparent">
        <div className="box-border content-stretch flex flex-col gap-[32px] items-center px-[36px] py-[80px] relative w-full">
          <Credits />
        </div>
      </div>
    </div>
