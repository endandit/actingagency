import svgPaths from "../../imports/svg-7v8rw9qsqg";
...
function Heading() {
  return (
    <div className="absolute box-border content-stretch flex flex-col gap-[12px] items-start left-[48px] px-[24px] py-0 top-[48px] w-[800px]" data-name="heading">
      <BlockTitle />
      <BlockSubTitle />
    </div>
  );
...
function DropdownContent({ value, onChange }: { value: string; onChange: (value: string) => void }) {
  ...
  return (
    <div className="absolute left-[48px] top-[176px] w-[800px]">
      <div 
        className="bg-[#fff7e4] box-border content-stretch flex h-[60px] items-center pl-[24px] pr-[12px] py-[6px] rounded-[30px] shadow-[4px_4px_0px_0px_#f4b9de] cursor-pointer" 
...
function ContainerInput({ 
  ...
  return (
    <div className="absolute box-border content-stretch flex flex-col gap-[36px] items-start left-[48px] px-[12px] py-0 top-[272px] w-[800px]" data-name="container/input">
...
function ButtonSend({ onClick, isSubmitting }: { onClick: () => void; isSubmitting: boolean }) {
  return (
    <button
      ...
      className="absolute bg-[#d0f4b9] box-border content-stretch flex h-[60px] items-center left-[48px] pl-[24px] pr-[12px] py-[6px] rounded-[40px] shadow-[4px_4px_0px_0px_#5dbdce] top-[560px] w-[800px] cursor-pointer border-none hover:opacity-90 transition-opacity disabled:opacity-50 disabled:cursor-not-allowed" 
...
function FormContact() {
  ...
  return (
    <div className="backdrop-blur-sm backdrop-filter bg-[rgba(208,244,185,0.25)] h-[668px] relative rounded-[24px] shrink-0 w-[896px]" data-name="form/contact">
      <Heading />
...
END:VCARD`;
  ...
  return (
    <div className="[grid-area:1_/_1] ml-0 mt-0 size-[178px] flex items-center justify-center bg-[#FDE9F5]" data-name="QR/code">
      <QRCode value={vCard} size={178} fgColor="#3B82F6" bgColor="#FDE9F5" />
    </div>
  );
}
...
function QrCode1() {
  return (
    <div className="grid-cols-[max-content] grid-rows-[max-content] inline-grid place-items-start relative w-full" data-name="QR/code">
      <QrCode />
    </div>
  );
}
...
function QrBackground() {
  return (
    <div className="bg-[#fde9f5] box-border content-stretch flex items-center justify-center p-[36px] relative rounded-[24px] shadow-[6px_6px_0px_0px_#3b82f6] size-[250px]" data-name="QR/background">
      <div className="basis-0 flex grow h-[calc(1px*((var(--transform-inner-width)*0.0631512701511383)+(var(--transform-inner-height)*0.9980039596557617)))] items-center justify-center leading-[0] min-h-px min-w-px relative shrink-0" style={{ "--transform-inner-width": "178", "--transform-inner-height": "178" } as React.CSSProperties}>
...
function ContainerQr() {
  return (
    <div className="backdrop-blur-sm backdrop-filter basis-0 bg-[rgba(143,210,244,0.25)] grow h-[490px] min-h-px min-w-px relative rounded-[24px] shrink-0" data-name="container/QR">
      <div className="[text-shadow:#010000_2px_2px_0px] absolute flex flex-col font-['Montserrat:Bold',sans-serif] font-bold justify-center leading-[0] left-[82px] text-[#fff7e4] text-[38px] text-nowrap top-[88.36px] translate-y-[-50%]">
        <p className="leading-[45.6px] whitespace-pre">Scan mij!</p>
      </div>
      <div className="absolute flex h-[calc(1px*((var(--transform-inner-width)*0.0631512701511383)+(var(--transform-inner-height)*0.9980039596557617)))] items-center justify-center left-[40.36px] top-[159.36px] w-[calc(1px*((var(--transform-inner-height)*0.0631512701511383)+(var(--transform-inner-width)*0.9980039596557617)))]" style={{ "--transform-inner-width": "250", "--transform-inner-height": "250" } as React.CSSProperties}>
...
function ContainerPhone() {
  return (
    <div className="absolute box-border content-stretch flex gap-[48px] h-[100px] items-center left-[48px] top-[47px] w-[406px]" data-name="container/phone">
      <IconPadding4 />
...
function ContainerMail() {
  return (
    <div className="absolute box-border content-stretch flex gap-[48px] h-[100px] items-center left-[48px] top-[195px] w-[406px]" data-name="container/mail">
      <IconPadding5 />
...
function ContainerLinkedin() {
  return (
    <a 
      ...
      className="absolute box-border content-stretch flex gap-[48px] h-[100px] items-center left-[48px] top-[343px] w-[406px] cursor-pointer no-underline" 
...
function ContainerInfo() {
  return (
    <div className="backdrop-blur-sm backdrop-filter bg-[rgba(249,135,207,0.25)] h-[490px] relative rounded-[24px] shrink-0 w-[502px]" data-name="container/info">
      <ContainerPhone />
      <ContainerMail />
      <ContainerLinkedin />
    </div>
...
function ContainerMain() {
  return (
    <div className="content-center flex flex-wrap gap-[48px] items-center relative shrink-0 w-[896px]" data-name="container/main">
      <FormContact />
      <ContainerQr />
      <ContainerInfo />
    </div>
