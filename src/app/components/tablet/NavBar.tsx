...
function DribbbleLightPreview() {
  return (
    <div className="absolute contents inset-0" data-name="Dribbble-Light-Preview">
      <svg className="block size-full pointer-events-none" fill="none" preserveAspectRatio="none" viewBox="0 0 60 60">
        <g id="icons">
...
function IconRetroPhone({ onClick }: { onClick: () => void }) {
  ...
  return (
    ...
    >
      <svg className="block size-full pointer-events-none" fill="none" preserveAspectRatio="none" viewBox="0 0 75 75">
...
function NavCentered({ onLogoClick, onScriptClick, onPhoneClick }: { onLogoClick: () => void; onScriptClick: () => void; onPhoneClick: () => void }) {
  return (
    <div className="absolute box-border content-stretch flex h-[216px] items-center justify-between left-0 px-[48px] py-[48px] top-0 w-full" data-name="nav/centered">
