...
function BlockDescription({ item }: { item: CarouselItem }) {
  return (
    <div className="backdrop-blur-sm backdrop-filter basis-0 bg-[rgba(255,247,228,0.05)] grow min-h-px min-w-px overflow-clip relative rounded-[9px] shrink-0 w-full" data-name="block/description">
...
function Wrapper() {
  return (
    <div className="content-stretch flex items-center justify-between relative shrink-0 w-full max-w-[1920px] mx-auto" data-name="wrapper">
      <ContainerAbout />
      <WrapperCarousel />
    </div>
  );
...
export default function HeaderContentDesktop() {
  return (
    <div className="flex flex-row items-center size-full">
      <div className="box-border content-stretch flex items-center justify-center p-[48px] relative w-full min-h-[calc(100vh-268px)] h-[calc(100vh-268px)]">
        <Wrapper />
      </div>
    </div>
  );
